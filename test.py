...
class GDTS:
    ...
    def Initialization(self): 
        ...
        self.heading = 0
        self.sensing_time = 1/self.turn_rate # seconds
    ...
    def IterLoop(self):  
        curr_dist = np.sqrt((self.transm_loc[0]-self.uav_pos[0])**2 + (self.transm_loc[1]-self.uav_pos[0])**2)
        ...
        while curr_dist > self.threshold_dist: 
            ...
            curr_dist = np.sqrt((self.transm_loc[0] - x)**2 + (self.transm_loc[1] - y)**2) 
